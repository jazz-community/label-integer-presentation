    ...
    const config = {
        ...
        plugins: [
            ...
            new JazzUpdateSitePlugin({
                appType: 'ccm',
                projectId: 'com.siemens.bt.jazz.workitemeditor.presentation.labelIntegerPresentation',
                acceptGlobPattern: [
                    'resources/**',
                    'META-INF/**',
                    'plugin.xml'
                    ...
                    test: [
                        {
                            folder: './',
                            method: (filePath) => {
                                return new RegExp(/com\.siemens\.bt\.jazz\.workitemeditor\.presentation\.labelIntegerPresentation.*\.zip$/, 'i').test(filePath);
                            }
                        }
                    ]
                },
